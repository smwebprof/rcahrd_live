...
class Addclientinteraction extends CI_Controller {
	...
	public function index()
	{
    	...
    	if ($_POST) {
	        ...
	        $clientsdata['client_id'] = $_POST['int_company'];
            ...
            $clients = $this->Interaction_master->updateClientData($clientsdata);
            ...
            $interactiondata['client_id'] = $_POST['int_company'];
	...
	public function fetch_clientdata123()
	{
	...
	public function fetch_clientdata()
    {
        ...
        echo $result['address']."|".$result['tel_no']."|".$result['company_web_page']."|".$result['country']."|".$result['state']."|".$result['city']."|".$result['countryid']."|".$result['stateid']."|".$result['cityid']."|".$result['country_code']."|".$result['email_address'];
    }
