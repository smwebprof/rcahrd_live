        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?php echo BASE_PATH; ?>/Viewusermaster">Item Group Master</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <form id="itemGroupForm" name="itemGroupForm" action="" method="post">
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Item Group Name</label>
                  <input type="text" name="item_groupname" id="item_groupname" class="form-control">
                </div>               
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Item Group Short Name</label>
                  <input type="text" class="form-control" name="item_shortname" id="item_shortname">
                </div>
