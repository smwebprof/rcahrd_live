    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php if (@$this->data['emp_details'][0]['add_self_form']=='N') {  ?>
          <h3>You have no access to this Form !!!</h3>
          <?php } else { ?>
          <?php
...
accordingly.</label>
                  ...
                  foreach ($questions as $k =>$v) { 
                            ...
                            <tr>
                              ...
                              <td>
                                <div>
                                  ...
                                  <option value="Inexperienced or Improvement Needed|1">1</option>
                                  <option value="Satisfactory|2">2</option>
                                  <option value="Very Competent|3">3</option>
                                  <option value="Outstanding|4">4</option>
                                </select>
                                </div>
                              </td>
                            </tr>
                    ...
                    <?php } else { ?>
                      <div class="form-group">
                      <label for="exampleInputEmail1"  style="font-weight:500;"><?php echo $v['id']." . ".$v['question_descriptioin'];?></label>
                      <textarea class="form-control" rows="3" name="self_que_<?php echo $v['id']; ?>" id="self_que_<?php echo $v['id']; ?>"></textarea>
