          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">View Item Group Master</h3>                  
                  <a href="<?php echo BASE_PATH; ?>additemgroupmaster"><button type="button" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Add Item Group</button></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
