          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">View Commodity Master</h3>                  
                  <a href="<?php echo BASE_PATH; ?>addcommoditymaster"><button type="button" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Add Commodity</button></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="<?php echo BASE_PATH; ?>editcommoditymaster?id=<?php echo base64_encode($v['id']); ?>"><button type="button" class="btn btn-warning float-middle">Edit</button></a>
                    </td>
                    <?php /*<td>
