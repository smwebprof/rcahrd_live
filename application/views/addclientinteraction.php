  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Client Interaction Form For Existing Clients</h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="" name="int_office_address" id="int_office_address"   tabindex="4">
                ...
                <div class="form-group">
                  ...
                  <label>Followup Date:</label>
                    <div class="input-group date" id="reservationdate2" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input"  data-target="#reservationdate2" name="interaction_date" id="interaction_date" value="" tabindex="16" readonly/>
