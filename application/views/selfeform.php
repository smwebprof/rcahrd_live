  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Self Assessment Form - Edit</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php if (@$this->data['form_status'][0]['status']=='Approved') {  ?>
          <h3>This Form is Closed!!!</h3>
          <?php } else { ?>
          <?php
          ...
          ?>
          <input type="hidden" name="user_self_id" id="user_self_id" value="<?php echo @$this->data['form_status'][0]['id']; ?>">
          <div class="row">
          <div class="col-md-6">
            <div class="card">
              <!--<div class="card-header">
...
accordingly.</label>
                  ...
                  foreach ($questions as $k =>$v) { 
                            ...
                            <tr>
                              ...
                              <td>
                                <div>
                                  ...
                                  <select class="form-control" name="self_que_<?php echo $v['id'].$x; ?>" id="self_que_<?php echo $v['id'].$x; ?>">
                                  <option value="">Select</option>
                                  <option value="Inexperienced or Improvement Needed|1" <?php if ($this->data['catans'][$v['id'].$x]==1) { echo 'selected';}  ?>>1</option>
                                  <option value="Satisfactory|2" <?php if ($this->data['catans'][$v['id'].$x]==2) { echo 'selected';}  ?>>2</option>
                                  <option value="Very Competent|3" <?php if ($this->data['catans'][$v['id'].$x]==3) { echo 'selected';}  ?>>3</option>
                                  <option value="Outstanding|4" <?php if ($this->data['catans'][$v['id'].$x]==4) { echo 'selected';}  ?>>4</option>
                                  </select>
                                </div>
                              </td>
                            </tr>
                    ...
                    <?php } else { ?>
                      <div class="form-group">
                      <label for="exampleInputEmail1"  style="font-weight:500;"><?php echo $v['id']." . ".$v['question_descriptioin'];?></label>
                      <textarea class="form-control" rows="3" name="self_que_<?php echo $v['id']; ?>" id="self_que_<?php echo $v['id']; ?>"><?php echo $v['breifanswer']; ?></textarea>
