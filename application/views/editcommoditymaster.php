        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?php echo BASE_PATH; ?>/Viewusermaster">Commodity Master</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <form id="commodityForm" name="commodityForm" action="" method="post">
          <?php $rows = $this->data['commodity_details'];
                      
          foreach($rows as $commodity_details){
          ?>
          <input type="hidden" name="id" id="id" value="<?php echo $commodity_details['id']; ?>">
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Commodity Name</label>
                  <input type="text" name="commodity_name" id="commodity_name" class="form-control" value="<?php echo $commodity_details['commodity_name']; ?>">
                </div>               
              ...
              <div class="col-md-6">
                <?php /*<div class="form-group">
                  ...
                  <select class="form-control select2" style="width: 100%;" name="subgroup" id="subgroup">
                    <option value="">Select</option>
                    <?php $rows = $this->data['subgroup_details'];
                      
                    foreach($rows as $subgroup_details){
                    ?>
                    <option value="<?php echo $subgroup_details['id']; ?>" <?php if($commodity_details['sub_group_id']==$subgroup_details['id']) { echo 'selected'; } ?>><?php echo $subgroup_details['name']; ?></option>
                    <?php } ?>
                  </select>
                </div>*/ ?>
